const fs = require('fs');
const WIZARD_PATH = 'frontend/components/assistant-ui/tools/vault-wizard/wizard.tsx';
const HOOK_PATH = 'frontend/components/assistant-ui/tools/vault-wizard/hooks/use-vault-creation.ts';

if (!fs.existsSync('frontend/components/assistant-ui/tools/vault-wizard/hooks')) {
    fs.mkdirSync('frontend/components/assistant-ui/tools/vault-wizard/hooks');
}
